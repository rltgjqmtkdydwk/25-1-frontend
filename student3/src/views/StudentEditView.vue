...
import { getStudent, putStudent, deleteStudent, getDepartments } from '@/backendService';
...
<template>
  <div>
    ...
    <form>
      ...
      <div>
        <button type="button" @click="updateStudent">저장</button>
        <button type="button" @click="removeStudent">삭제</button>
